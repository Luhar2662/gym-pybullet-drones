...
def play(model_path=DEFAULT_MODEL_PATH, multiagent=DEFAULT_MA, gui=DEFAULT_GUI, random_init = DEFAULT_RANDOM_INIT, random_eval = DEFAULT_RANDOM_EVAL):
    #### Load saved model ####
    ...
    #Reset twice to load random option!
    obs, _ = env.reset(seed=42, options={})
